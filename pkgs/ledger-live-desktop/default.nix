...
{ stdenv, fetchurl, makeDesktopItem, appimageTools, gsettings-desktop-schemas, gtk3, imagemagick }:
...
let
  ...
  src = fetchurl {
    ...
    sha256 = "1e240444a90de0e4e1fd5bccf4bb1c4b54720e98673dc40cba178895f3c419ad";
  };
